...
namespace QIQO.Accounts.Data
{
    public class FeeScheduleRepository : RepositoryBase<FeeScheduleData>, IFeeScheduleRepository
    {
        ...
        public FeeScheduleRepository(IAccountDbContext dbc, IFeeScheduleMap map, ILogger<FeeScheduleData> logger) : base(map)
        {
            entityContext = dbc;
            _logger = logger;
        }
        ...
        //    using (entityContext)
        //    {
        //        return MapRows(entityContext.ExecuteProcedureAsSqlDataReader("uspFeeScheduleAllByProduct", pcol));
        //    }
        //}
