...
namespace QIQO.Accounts.Data
{
                                     ...
                                     IAccountRepository
    {
        ...
        public AccountRepository(IAccountDbContext dbc, IAccountMap map, ILogger<AccountData> logger) : base(map)
        {
            entityContext = dbc;
            _logger = logger;
        }
        ...
        public override AccountData GetByCode(string account_code, string entityCode)
        {
            ...
            using (entityContext) return MapRow(entityContext.ExecuteProcedureAsSqlDataReader("uspAccountGetByCode", pcol));
        }
        ...
        public override void Delete(AccountData entity)
        {
            ...
            using (entityContext) entityContext.ExecuteProcedureNonQuery("uspAccountDelete", Mapper.MapParamsForDelete(entity));
        }
        ...
        {
            _logger.LogInformation("Accessing AccountRepo Delete function");
            using (entityContext) entityContext.ExecuteProcedureNonQuery("uspAccountDelete", Mapper.MapParamsForDelete(entityKey));
        }
